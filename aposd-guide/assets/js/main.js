/* ============================================================
   ...
   copy · quizzes · reveal-on-scroll · Python (+ shell) highlighter
   ============================================================ */
(function () {
  "use strict";
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("aposd-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("aposd-theme"); } catch (e) {}
