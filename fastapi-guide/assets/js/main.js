...
(function () {
  ...
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("fa-theme"); } catch (e) {}
  ...
  var PY_BI = ["print","len","str","int","float","list","dict","set","tuple","bool","range","enumerate","zip","open","type","isinstance","super","self","cls","map","filter","sorted","sum","min","max","abs","input","format","join","append","Annotated","TypedDict","Optional","List","Dict",
    // FastAPI / Pydantic / SQLModel / typing names — color them like builtins
    "FastAPI","APIRouter","Depends","Query","Path","Body","Header","Cookie","Form","File","UploadFile","Request","Response","JSONResponse","HTTPException","BackgroundTasks","status","CORSMiddleware","TestClient",
    "BaseModel","Field","ConfigDict","field_validator","model_validator","EmailStr","ValidationError",
    "SQLModel","Session","Relationship","select","create_engine",
    "datetime","date","UUID","uuid4","Enum","bytes","Any","Union","Literal","Sequence"];
