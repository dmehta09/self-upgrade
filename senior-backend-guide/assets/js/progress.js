/* ============================================================
   Senior Backend Scenario Q&A — progress tracking (offline, no deps)
   ...
   localStorage key: senior-backend-progress = { "<lesson-id>": { done: true, ts } }
   ============================================================ */
(function () {
  "use strict";
  var KEY = "senior-backend-progress";
