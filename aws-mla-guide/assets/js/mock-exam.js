/* Timed MLA mock — reads #mockBank JSON, scores by domain, teaches on review */
(function () {
  ...
  function mount(root) {
    ...
    shell.innerHTML =
      ...
      '<span>Mode: domain-weighted MLA-C02</span></div>' +
      '<div id="mqList"></div>' +
    ...
    function score() {
      ...
      scoreEl.innerHTML = "<p><b>Score: " + correct + " / " + qs.length + " (" + pct + "%)</b></p>" +
        "<p>Domain bars first — then read each explanation and open the lesson link.</p>" +
