/* ============================================================
   AWS MLA Field Guide — shared behaviors (no dependencies, offline)
...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("aws-mla-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("aws-mla-theme"); } catch (e) {}
