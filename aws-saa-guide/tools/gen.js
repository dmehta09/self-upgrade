#!/usr/bin/env node
/* ============================================================
   AWS SAA Field Guide — page assembler (dev-time only; output
...
function sidebar(p) {
  ...
  s += `        <span class="brand-text"><b>${BRAND}</b><span>SAA-C03 · Well-Architected · Sep 2026</span></span>\n`;
  s += `      </a>\n`;
...
function renderPage(page, sections, pages, i) {
  ...
  const desc = BRAND + " — " + page.title + ". A sharp, visual, exam-focused guide to AWS Solutions Architect Associate SAA-C03 — Sep 2026";
  return `<!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="${p}assets/css/aws-saa.css" />
