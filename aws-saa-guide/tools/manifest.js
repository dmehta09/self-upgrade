...
const MODULES = [
  { key: "foundations", label: "Foundations", pages: [
    { slug: "cloud-mental-model", title: "Cloud mental model", nav: "Cloud mental model", id: "fo-cloud", widgets: ["mermaid-init.js"] },
    { slug: "regions-azs-edge", title: "Regions, AZs & the edge", nav: "Regions & AZs", id: "fo-regions", widgets: ["mermaid-init.js"] },
    { slug: "well-architected", title: "Well-Architected Framework", nav: "Well-Architected", id: "fo-wa", widgets: ["mermaid-init.js"] },
    { slug: "shared-responsibility", title: "Shared responsibility", nav: "Shared responsibility", id: "fo-shared" },
  ...
  { key: "identity-security", label: "Identity & Security", pages: [
    { slug: "iam-users-roles-policies", title: "IAM users, roles & policies", nav: "IAM", id: "sec-iam", widgets: ["mermaid-init.js"] },
  ...
  { key: "compute", label: "Compute", pages: [
    ...
    { slug: "elb-patterns", title: "Elastic Load Balancing patterns", nav: "ELB patterns", id: "cmp-elb", widgets: ["mermaid-init.js"] },
  ...
  { key: "storage", label: "Storage", pages: [
    { slug: "s3-classes-and-access", title: "S3 storage classes & access", nav: "S3", id: "sto-s3", widgets: ["mermaid-init.js"] },
    { slug: "ebs-efs-fsx", title: "EBS, EFS & FSx", nav: "EBS · EFS · FSx", id: "sto-block", widgets: ["mermaid-init.js"] },
    { slug: "aws-backup", title: "AWS Backup & protection", nav: "AWS Backup", id: "sto-backup" },
  ]},
  { key: "databases", label: "Databases", pages: [
    ...
    { slug: "elasticache", title: "ElastiCache", nav: "ElastiCache", id: "db-cache" },
  ]},
  { key: "integration", label: "Application Integration", pages: [
    { slug: "sqs-sns-eventbridge", title: "SQS, SNS & EventBridge", nav: "SQS · SNS · EB", id: "int-msg", widgets: ["mermaid-init.js"] },
  ...
  { key: "resilience", label: "Resilience & DR", pages: [
    ...
    { slug: "decoupling-and-scaling", title: "Decoupling & scaling patterns", nav: "Decouple & scale", id: "res-scale", widgets: ["mermaid-init.js"] },
  ]},
  { key: "cost-ops", label: "Cost & Operations", pages: [
    ...
    { slug: "cost-explorer-budgets", title: "Cost Explorer, Budgets & allocation", nav: "Cost tooling", id: "cost-tools" },
...
const EXAM_PREP = [
  ...
  { dir: "exam", slug: "scenario-bank", title: "Architecture scenario bank", nav: "Scenario bank", id: "ex-scenarios" },
