#!/usr/bin/env node
/* ============================================================
   CKA Field Guide — page assembler (dev-time only; output
...
function sidebar(p) {
  ...
  s += `        <span class="brand-text"><b>${BRAND}</b><span>CKA · K8s v1.35 · Sep 2026</span></span>\n`;
  s += `      </a>\n`;
...
function renderPage(page, sections, pages, i) {
  ...
  const desc = BRAND + " — " + page.title + ". A sharp, visual, exam-focused guide to Certified Kubernetes Administrator (CKA) on Kubernetes v1.35 — Sep 2026";
  return `<!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="${p}assets/css/cka.css" />
...
${mainWrap(page, sections, pages, i)}
      <footer class="footer">
        <span class="fmono">${BRAND} &middot; CKA · K8s v1.35 &middot; Sep 2026</span>
