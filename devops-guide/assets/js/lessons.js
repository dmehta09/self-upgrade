...
window.LESSONS = [
  ...
  { id: "ci-auth", title: "Pipeline auth, OIDC & reusable workflows", url: "cicd/pipeline-auth-and-reuse.html", module: "cicd", tool: "cicd" },
  ...
  { id: "ku-helm", title: "Helm & Kustomize packaging", url: "kubernetes/helm-and-kustomize.html", module: "kubernetes", tool: "kubernetes" },
  { id: "ku-security", title: "RBAC, NetworkPolicy & PSA", url: "kubernetes/security-and-policy.html", module: "kubernetes", tool: "kubernetes" },
  ...
  { id: "pl-idp", title: "IDPs & golden paths", url: "platform/idp-and-golden-paths.html", module: "platform", tool: "platform" },
  { id: "pl-catalog", title: "Service catalog & developer portals", url: "platform/service-catalog.html", module: "platform", tool: "platform" },
  ...
  { id: "op-handoff", title: "Deploy health → observability handoff", url: "operate/deploy-health-handoff.html", module: "operate", tool: "operate" },
...
window.LESSON_MODULES = [
  ...
  { key: "platform", label: "Platform Engineering" },
