#!/usr/bin/env node
/* ============================================================
   DevOps Field Guide — page assembler (dev-time only; output
...
const ICON = "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%2322d3ee' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'><path d='M12 12c-2-2.67-4-4-6-4a4 4 0 1 0 0 8c2 0 4-1.33 6-4Zm0 0c2 2.67 4 4 6 4a4 4 0 0 0 0-8c-2 0-4 1.33-6 4Z'/></svg>";
const BRAND = "DevOps Field Guide";
...
function sidebar(p) {
  ...
  s += `        <span class="brand-text"><b>${BRAND}</b><span>Build &rarr; ship &rarr; operate &middot; interview-ready</span></span>\n`;
  s += `      </a>\n`;
...
function renderPage(page, sections, pages, i) {
  ...
  const desc = BRAND + " — " + page.title + ". A sharp, visual, interview-ready guide to modern DevOps — CI/CD, Docker, Kubernetes, Terraform, AWS, deploy strategies & reliability — June 2026.";
  return `<!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="${p}assets/css/devops.css" />
