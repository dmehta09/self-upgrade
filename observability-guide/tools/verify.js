#!/usr/bin/env node
/* Static verification for the Observability Field Guide.
   Crawls every .html under the project root (excluding tools/) and checks:
     ...
     • each lesson page wires the 6 JS modules and sets SITE_BASE + data-lesson
...
const REQUIRED_SCRIPTS = ["lessons.js", "search-index.js", "main.js", "search.js", "visualizer.js", "progress.js"];
// mount class -> engine script that must be present when the class appears
const ENGINES = {
  tracewf: "trace-waterfall.js",
  serieslab: "series-lab.js",
  budgetburn: "budget-burn.js",
  samplingviz: "sampling-viz.js",
  queryexp: "query-explorer.js",
