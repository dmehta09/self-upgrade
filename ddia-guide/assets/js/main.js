/* ============================================================
   DESIGNING DATA-INTENSIVE APPLICATIONS — shared behaviors (no deps, offline)
...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("ddia-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("ddia-theme"); } catch (e) {}
  ...
  var PY_BI = ["print","len","str","int","float","list","dict","set","tuple","bool","range","enumerate","zip","open","type","isinstance","issubclass","super","self","cls","map","filter","sorted","sum","min","max","abs","input","format","join","append","object","property","staticmethod","classmethod","abstractmethod","dataclass","field","Protocol","ABC","ABCMeta","Enum","IntEnum","auto","cache","cached_property","lru_cache","wraps","deepcopy","copy","namedtuple","defaultdict","Counter","Any","Callable","Iterator","Iterable","Sequence","Mapping","Optional","List","Dict","Annotated","TypedDict","Self","Final","frozenset","bytes","hash","id","repr","vars","dir","getattr","setattr","hasattr","delattr","NotImplemented"];
  ...
  function highlightShell(code) {
    return esc(code).replace(/^(\s*)(\$)(\s)/gm, '$1<span class="tok-prompt">$</span>$3')
                    .replace(/\b(pip|python|python3|uv|export|pytest|mypy|ruff|venv)\b/g, '<span class="tok-bi">$1</span>')
