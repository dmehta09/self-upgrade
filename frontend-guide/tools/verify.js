#!/usr/bin/env node
/* Static verification for the Frontend Field Guide.
   Crawls every .html under the project root (excluding tools/) and checks:
     ...
     • no raw "<" inside <code> blocks (would break the highlighter / JSX)
...
const ENGINES = {
  renderviz: "render-viz.js",
  efftimeline: "effect-timeline.js",
  rscviz: "rsc-boundary.js",
