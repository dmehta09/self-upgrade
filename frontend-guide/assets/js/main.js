...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("fe-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("fe-theme"); } catch (e) {}
  ...
  function highlightAll() {
    document.querySelectorAll(".codeblock pre code").forEach(function (el) {
      ...
      var lang = (el.getAttribute("data-lang") || "tsx").toLowerCase();
