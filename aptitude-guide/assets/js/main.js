/* ============================================================
   APTITUDE & REASONING FIELD GUIDE — shared behaviors (no deps, offline)
...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("apti-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("apti-theme"); } catch (e) {}
