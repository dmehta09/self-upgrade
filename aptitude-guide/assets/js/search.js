/* ============================================================
   Aptitude & Reasoning Field Guide — client-side full-text search
    ...
    overlay.innerHTML =
      '<div class="search-modal" role="dialog" aria-label="Search">' +
        '<div class="search-head">' +
          ...
          '<input class="search-input" type="text" placeholder="Search topics - percentages, syllogism, blood relations, data sufficiency" aria-label="Search query" autocomplete="off" spellcheck="false" />' +
        '</div>' +
