#!/usr/bin/env node
/* Static verification for The Lang Stack.
   Crawls every .html under the project root and checks:
     ...
     • every engine embed loads its script (a config without its engine is a dead box)
...
for (const f of files) {
  ...
  const ENGINES = [
    ["data-graphsim", ["graphsim.js"]],
    ["data-tracelab", ["tracelab.js"]],
    ["data-pipeviz", ["pipeviz.js"]],
