/* ============================================================
   THE LANG STACK — client-side full-text search (no deps)
    ...
    overlay.innerHTML =
      '<div class="search-modal" role="dialog" aria-label="Search">' +
        '<div class="search-head">' +
          ...
          '<input class="search-input" type="text" placeholder="Search the guide - try reducer, traces, LCEL, checkpointer" aria-label="Search query" autocomplete="off" spellcheck="false" />' +
        '</div>' +
