    ...
    overlay.innerHTML =
      '<div class="search-modal" role="dialog" aria-label="Search">' +
        '<div class="search-head">' +
          ...
          '<input class="search-input" type="text" placeholder="Search the guide - try polymorphism, singleton, SOLID, parking lot" aria-label="Search query" autocomplete="off" spellcheck="false" />' +
        '</div>' +
