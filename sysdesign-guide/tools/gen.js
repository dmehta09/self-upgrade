...
const PAGES = [
  ...
  { out: "blocks/index.html",                  mod: "blocks", lesson: "blocks-overview",  title: "The building blocks", desc: "The handful of boxes every architecture is made of — and how a request moves through them." , scripts: ["reqflow.js"] },
  { out: "blocks/load-balancing.html",         mod: "blocks", lesson: "blocks-lb",        title: "Load balancing", desc: "Spreading traffic across servers: L4 vs L7, algorithms, health checks, and stateless design.", scripts: ["reqflow.js","visualizer.js"] },
  ...
  { out: "core/distributed-cache.html",        mod: "core", lesson: "core-cache",        title: "Design a distributed cache", desc: "A Redis-like cache at scale: consistent hashing, replication, eviction, write policies, and the hot-key problem.", scripts: ["reqflow.js","visualizer.js","tradeoff.js"] },
  ...
  { out: "core/news-feed.html",                mod: "core", lesson: "core-news-feed",    title: "Design a news feed (Twitter)", desc: "The iconic feed problem: fan-out on write vs read, the celebrity case, and timeline caching.", scripts: ["reqflow.js","tradeoff.js","capacity.js"] },
  ...
  { out: "core/chat.html",                     mod: "core", lesson: "core-chat",         title: "Design a chat system (WhatsApp)", desc: "Real-time messaging: WebSockets, presence, delivery and ordering guarantees, and group fan-out.", scripts: ["reqflow.js"] },
