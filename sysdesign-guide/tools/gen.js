...
const PAGES = [
  ...
  { out: "fundamentals/consistency.html",      mod: "fundamentals", lesson: "fund-consistency",   title: "Consistency, CAP & PACELC", desc: "Strong vs eventual, linearizability vs session guarantees, CAP, and PACELC — with a quorum lab and trade-off slider.", scripts: ["tradeoff.js","quorum.js"] },
  { out: "fundamentals/async-patterns.html",   mod: "fundamentals", lesson: "fund-async-patterns", title: "CQRS, outbox, sagas & idempotency", desc: "The async backbone of mid-senior designs: CQRS, transactional outbox, saga choreography vs orchestration, idempotency keys, and the exactly-once illusion.", scripts: ["tradeoff.js","reqflow.js"] },
  { out: "fundamentals/multi-region.html",     mod: "fundamentals", lesson: "fund-multi-region",  title: "Multi-region, DR & data residency", desc: "Active-active vs active-passive, RPO/RTO, GeoDNS and latency routing, residency, conflict resolution, and a DR runbook.", scripts: ["tradeoff.js"] },
  ...
  { out: "core/news-feed.html",                mod: "core", lesson: "core-news-feed",    title: "Design a news feed (Twitter)", desc: "The iconic feed problem: fan-out on write vs read, the celebrity case, and timeline caching.", scripts: ["reqflow.js","tradeoff.js","capacity.js","journey.js","failsim.js"] },
  ...
  { out: "core/chat.html",                     mod: "core", lesson: "core-chat",         title: "Design a chat system (WhatsApp)", desc: "Real-time messaging: WebSockets, presence, delivery and ordering guarantees, and group fan-out.", scripts: ["reqflow.js","journey.js","failsim.js"] },

  { out: "advanced/uber.html",                 mod: "advanced", lesson: "adv-uber",     title: "Design Uber / ride-hailing", desc: "Match riders to nearby drivers in real time: geospatial indexing (geohash/QuadTree/H3), dispatch, and ETA.", scripts: ["reqflow.js","visualizer.js","tradeoff.js","failsim.js"] },
  { out: "advanced/youtube.html",              mod: "advanced", lesson: "adv-youtube",  title: "Design YouTube / video streaming", desc: "Upload, transcode, and stream video globally: the CDN, adaptive bitrate, blob storage, and the view path.", scripts: ["reqflow.js","capacity.js","failsim.js"] },
  ...
  { out: "advanced/feature-store.html",        mod: "advanced", lesson: "adv-feature-store", title: "Design a real-time ML feature store", desc: "Features for ML, served twice: point-in-time-correct training sets offline and sub-10 ms lookups online — training-serving skew, ASOF joins, freshness vs cost, Feast/Tecton patterns (2026).", scripts: ["reqflow.js","tradeoff.js","capacity.js"] },
  ...
  { out: "expert/cell-architecture.html",       mod: "expert", lesson: "expert-cells",          title: "Design a cell-based architecture", desc: "Bound the blast radius: shared-nothing cells with a thin static-stable router, wave deploys, shuffle sharding, poison-pill containment, and cell migration — the Slack/AWS playbook.", scripts: ["reqflow.js","visualizer.js","failsim.js"] },
...
const NAV = [
  ...
  { h: "Fundamentals", cls: "is-fundamentals", links: [["fundamentals/index.html","Reading a design question"],["fundamentals/estimation.html","Back-of-envelope math"],["fundamentals/numbers.html","Numbers you must know"],["fundamentals/availability.html","Availability &amp; SLAs"],["fundamentals/consistency.html","Consistency · CAP · PACELC"],["fundamentals/async-patterns.html","CQRS · outbox · sagas"],["fundamentals/multi-region.html","Multi-region &amp; DR"]] },
  ...
  { h: "Advanced designs", cls: "is-advanced", links: [["advanced/uber.html","Uber / ride-hailing"],["advanced/youtube.html","YouTube / streaming"],["advanced/payments.html","Payment system"],["advanced/llm-serving.html","LLM serving"],["advanced/vector-recommender.html","Vector search &amp; recsys"],["advanced/feature-store.html","ML feature store"]] },
  { h: "Expert designs", cls: "is-expert", links: [["expert/multi-tenancy.html","Multi-tenant SaaS"],["expert/cell-architecture.html","Cell architecture"],["expert/user-management.html","User management"],["expert/org-management.html","Organizations &amp; teams"],["expert/authentication.html","Authentication"],["expert/authorization.html","Authorization"],["expert/ecommerce-catalog.html","E-commerce: catalog &amp; cart"],["expert/ecommerce-checkout.html","E-commerce: checkout"],["expert/billing.html","Billing &amp; subscriptions"],["expert/audit-log.html","Audit log"]] },
