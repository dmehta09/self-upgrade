/* ============================================================
   Cert Mocks Guide — shared behaviors (no dependencies, offline)
...
(function () {
  ...
  function applyTheme(t) {
    ...
    try { localStorage.setItem("cert-mocks-theme", t); } catch (e) {}
  }
  (function initTheme() {
    var saved;
    try { saved = localStorage.getItem("cert-mocks-theme"); } catch (e) {}
